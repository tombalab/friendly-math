...
**MVP kl. 4–8:** w UI widocznych jest 6 tematów rachunkowych; blueprinty dla klas 5–8 często są `downgraded` z kl. 4. Komunikat w sidebarze: `upper_grades_mvp_caption_pl()`.
...
| 1 | `czas` | czas | exact | none | tak | — | Ryzyko (brak klucza) |
| 1 | `pomiary_dlugosci` | pomiary długości | exact | none | tak | — | Ryzyko |
| 1 | `zadania_tekstowe` | zadania tekstowe | exact | none | tak | — | Częściowe |
...
| 2 | `pieniadze` | pieniądze | exact | none | tak | — | Ryzyko |
| 2 | `czas` | czas | exact | none | tak | — | Ryzyko |
| 2 | `pomiary_dlugosci` | pomiary długości | exact | none | tak | — | Ryzyko |
| 2 | `obwody` | obwody | exact | none | tak | — | Ryzyko |
| 2 | `zadania_tekstowe` | zadania tekstowe | exact | none | tak | — | Częściowe |
...
| 3 | `pieniadze` | pieniądze | exact | none | tak | — | Ryzyko |
| 3 | `czas` | czas | exact | none | tak | — | Ryzyko |
| 3 | `pomiary_dlugosci` | pomiary długości | exact | none | tak | — | Ryzyko |
| 3 | `obwody` | obwody | exact | none | tak | — | Ryzyko |
| 3 | `zadania_tekstowe` | zadania tekstowe | exact | none | tak | — | Częściowe |
| 4 | `dzielenie` | dzielenie | downgraded | full | tak | tak | MVP rachunek |
...
| 5–8 | `dzielenie` … `rownania` | 6 tematów | downgraded* | full/partial | tak | częściowo | MVP — nie pełne PP |

\* Dla klas 5–8 większość tematów ogólnych ma `downgraded` blueprint; wyjątki `exact`: m.in. `ulamki` kl. 4, `rownania` kl. 5.
